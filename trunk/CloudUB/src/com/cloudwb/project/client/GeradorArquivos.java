...
public class GeradorArquivos {
	...
	public GeradorArquivos(PaginaCliente pgCliente, DecoratedTabPanel 

tabPanelVisualizaPagina){
		...
		tabPanelVisualizaPagina.add(vPanelVisualizaPagina, 
