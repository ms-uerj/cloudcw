...
public class CriadorTab {
	...
	public VerticalPanel criaTabLayout() {
		...
		HTML hTMLImagemOp1 = new HTML("&nbsp<IMG SRC='images/estrutura1.gif'> &nbsp&nbsp&nbsp&nbsp</P>");
		HTML hTMLImagemOp2 = new HTML("&nbsp<IMG SRC='images/estrutura2.gif'> </P>");
		HTML hTMLImagemOp3 = new HTML("&nbsp<IMG SRC='images/estrutura3.gif'> &nbsp&nbsp&nbsp&nbsp</P>");
		HTML hTMLImagemOp4 = new HTML("&nbsp<IMG SRC='images/estrutura4.gif'> </P>");
	...
	private void visualizaPagina() {
		String dados = new String("Nome do Site: " + pagCliente.getNomeSite()
				+ "\nTitulo da Pagina: " + pagCliente.getTituloSite()
				+ "\nBanner: " + pagCliente.getBannerSite() + "\nGraduacao: "
